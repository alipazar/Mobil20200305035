...
public final class FragmentAnasayfaBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView filmRv;

  @NonNull
  public final Toolbar toolbarAnasayfa;

  private FragmentAnasayfaBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView filmRv,
  ...
  public static FragmentAnasayfaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.filmRv;
      RecyclerView filmRv = ViewBindings.findChildViewById(rootView, id);
      if (filmRv == null) {
        break missingId;
      }
      ...
      return new FragmentAnasayfaBinding((ConstraintLayout) rootView, filmRv, toolbarAnasayfa);
    }
